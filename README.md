...
*그림 7. 페르소나를 결정하는 F1∼F5 비중 공간의 PCA(PC1 56.6%, PC2 23.1%). K→F 배정은 위 표(라이브 참고 재적합의 φ·병합 높이는 저장되지 않아 덴드로그램은 없음; 동결 K=10 덴드로그램은 `assets/readme/fig07a_persona_dendrogram_frozen_v7_40.png`). 생성: `v7_final_10020/charts/build_live_layer_figures_v7.py`. 동결 계층의 재현 노트북은 `v7_final_10020/analysis/persona_decision_space/`(K→F 10/10, 페르소나 100/100).*
