...
- 보조지표는 사전에 없는 표현(다큐멘터리·라디오, 사전 밖 브랜드명)을 포착하지 못하고, MCI는 멤버 수가 적을수록 구조적으로 높다. 누락의 크기를 가늠하면, 사전 밖 유사 표현이 든 미매칭 불릿이 광고 284건(미매칭의 3.3%), 미디어 214건(2.4%: 라디오·다큐·뮤지컬·위버스 등), 지역 93건(1.0%)이고 사람 검수용 표본 200건씩을 `v7_final_10020/analysis/unmatched_audit/`에 뒀다(검수는 아직).
