...
| 해석 계층 그림 | `v7_final_10020/charts/build_live_layer_figures_v7.py` (`KFONT_PATH`로 한글 폰트) | `live_interpretive_layer/` JSON·CSV, 3D payload | `assets/readme/fig05_persona_map.png`·`fig06_factor_specific_impact.png`·`fig07b_persona_pca.png` (K→F 배정은 README 5절 표) + `live_pca_v7.json` (동결 판은 `*_frozen_v7_40.png`) |
