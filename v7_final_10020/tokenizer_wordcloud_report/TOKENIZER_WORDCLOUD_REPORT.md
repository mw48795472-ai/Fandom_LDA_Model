...
> 점을 분명히 밝힌다.
>
> **[추가]** 저장소 정리 단계에서 근사 복원 코퍼스(7,326/7,350건)와 재구성 라우팅 토크나이저로 같은 재적합을 다시 시도했다.
> 결과는 토픽 10개 중 1개가 상위 10단어 8개 이상, 6개가 5개 이상 겹치고 M=5 실루엣은 0.07(동결 0.267)로, 위 0/10보다는 가깝지만
> 같은 결론이다 — 동결 스냅샷은 저장된 값으로만 남는다(`analysis/persona_decision_space/topic_phi_cosine/frozen_v7_40/FROZEN_MODEL_REFIT_V7_40.md`).
